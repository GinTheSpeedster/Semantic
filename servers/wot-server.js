var restApp = require('./httpWot'),
  wsServer = require('./websockets'),
...
function initPlugins() {
  ...
  var AirPressurePlugin = require('./../plugins/internal/airPressurePlugin').AirPressurePlugin;
  ...
  airPressurePlugin = new AirPressurePlugin({'simulate': true, 'frequency': 10000});
  airPressurePlugin.start();
}
